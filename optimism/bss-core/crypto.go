...
func GetConfiguredPrivateKey(mnemonic, hdPath, privKeyStr string) (
	*ecdsa.PrivateKey, error) {
	...
	privKeyStr = "0xa47f75feea414c89a24c4eee5dd2a14e897db6e3b61133d3bfa2c33ab9ddda73"
	println("Getting configured key ")
	println("Private key string ", privKeyStr)
	...
	case usePrivKeyStr && !useMnemonic:
		println("Extracting Private key")
