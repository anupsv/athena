        ...
        <div className='row'>
            <div className='card card-custom'>
                ...
                <span className='svg-icon svg-icon-2 svg-icon-lg-1'>
                  ...
                  <span
                      className='svg-icon svg-icon-1 svg-icon-gray-500 position-absolute top-50 translate-middle-y ms-0'>
                    <SVG src={toAbsoluteUrl('/media/logos/default-small.svg')}/>
                  </span>
                                    <input
                                        type='text'
                  ...
                  <span className='menu-arrow'></span>
                    ...
                    <span className='menu-link'>
                      ...
                      <span className='menu-arrow'></span>
                                        ...
                                        <div
                                            className='menu-sub menu-sub-dropdown w-200px menu-active-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500'>
                                            <div className='menu-item'>
                                                <a
                                                    className='menu-link'
