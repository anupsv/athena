                ...
                form-check form-check-custom form-check-solid form-check-success form-switch ms-10
                  ...
                  '
                                ...
                                <div className='form-group d-flex flex-stack'>
                                    ...
                                    <div className='d-flex justify-content-end'>
                                        <div
                                            className='form-check form-check-custom form-check-success form-check-solid form-check-sm ms-10'>
                                            <input
                                                className='form-check-input'
                                                type='radio'
                            ...
                            <div className={clsx('tab-pane', {active: tab === 'Toolbar'})}>
                                <div className='form-group d-flex flex-stack'>
                                    ...
                                    <div className='d-flex justify-content-end'>
                                        <div className='d-flex justify-content-end'>
                                            <div
                                                className='form-check form-check-custom form-check-solid form-check-success form-switch me-10'>
                                                <input
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div
                                            className='form-check form-check-custom form-check-success form-check-sm form-check-solid'>
                                            <input
                                                className='form-check-input'
                                                type='radio'
                                                // checked="checked"
